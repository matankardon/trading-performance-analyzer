...
import { demoDataMetadata, demoExpertOpinions as expertOpinions, demoSentimentRows as sentimentRows } from "../services/data";
...
function MarketSentiment() {
  ...
  return (
    <div className="sentiment-dashboard-page">
      <header className="topbar sentiment-dashboard-header"><div><p className="eyebrow">MARKET INTELLIGENCE</p><h1>Market Sentiment</h1><p>Understand how available professional views are leaning across the tracked market set.</p><DataSourceMeta metadata={demoDataMetadata} /></div><span className="market-page-status">EXTERNAL VIEWS · DEMO</span></header>
